...
Confirmed July 1, 2026:

1. Restore the Growth OS home base.
2. Build the dashboard data layer.
3. Rebuild the GTM source of truth.
4. Verify live inputs one at a time.
5. Rebuild the dashboard as an operating surface.

Morning sweep is lower priority for now. Do not make it the primary workflow until the home base, dashboard data layer, live inputs, and GTM source of truth are restored.
